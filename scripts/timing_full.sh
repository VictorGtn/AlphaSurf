...
OUTPUT_CSV="timing_results_full_$(date +%Y%m%d_%H%M%S).csv"

echo "=============================================="
echo "Timing Benchmark: Full Pipeline (Both Methods)"
echo "=============================================="
echo "Date: $(date)"

# Run Both methods automatically (parameters hardcoded in python script)
echo "--> Running method=both with --simplify --compute-operators --compute-features..."
