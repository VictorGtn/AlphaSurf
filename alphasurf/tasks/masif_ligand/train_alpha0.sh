#!/bin/bash -l
#SBATCH --job-name=atomsurf_alpha0
#SBATCH --output=/cluster/CBIO/data2/vgertner/atomsurf/log/train_alpha0_%j.log
#SBATCH --error=/cluster/CBIO/data2/vgertner/atomsurf/log/train_alpha0_%j.err
...
python3 train.py \
  ...
  run_name=hybrid_gvp_3layers_alpha0 \
