#!/bin/bash
#SBATCH --job-name=atomsurf_alpha1
#SBATCH --output=/mnt/data4/vgertner/atomsurf/log/train_alpha1_%j.log
#SBATCH --error=/mnt/data4/vgertner/atomsurf/log/train_alpha1_%j.err
