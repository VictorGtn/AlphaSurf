#!/bin/bash
#SBATCH --job-name=atomsurf_msms01_patches
#SBATCH --output=/cluster/CBIO/data2/vgertner/atomsurf/log/train_msms01_patches_%j.log
#SBATCH --error=/cluster/CBIO/data2/vgertner/atomsurf/log/train_msms01_patches_%j.err
...
python3 train.py \
  ...
  run_name=hybrid_gvp_3layers_full \
