#!/bin/bash
#SBATCH --job-name=atomsurf_alpha25
#SBATCH --output=/cluster/CBIO/data2/vgertner/atomsurf/log/train_alpha25_%j.log
#SBATCH --error=/cluster/CBIO/data2/vgertner/atomsurf/log/train_alpha25_%j.err
