#!/bin/bash -l
#SBATCH --job-name=atomsurf_msms
#SBATCH --output=/cluster/CBIO/data2/vgertner/atomsurf/log/train_msms_%j.log
#SBATCH --error=/cluster/CBIO/data2/vgertner/atomsurf/log/train_msms_%j.err
...
python3 train.py \
  ...
  run_name=hybrid_gvp_3layers_msms \
